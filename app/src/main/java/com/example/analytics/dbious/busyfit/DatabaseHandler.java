...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String[] INSERT_WORKOUT_SCHEDULE = {
            ...
            "INSERT INTO WORKOUT_SCHEDULE (workoutID, name, weekPart, dayPart, hourPart, muscleGroupID1, muscleGroupID2, calPerTime, desc) VALUES (1007, 'Punching', 4, 3, 3, 1, 0, 6, 'While rocking foot to foot, punch with alternating arms. To reduce elbow stress, try not to fully straighten your arm. ');",
            ...
            "INSERT INTO WORKOUT_SCHEDULE (workoutID, name, weekPart, dayPart, hourPart, muscleGroupID1, muscleGroupID2, calPerTime, desc) VALUES (1009, 'Side Lunge', 2, 2, 3, 2, 0, 7, 'Place hands on edge of desk, shoulder width apart, legs out behind you. Push off with as much force as you can. ');",
            "INSERT INTO WORKOUT_SCHEDULE (workoutID, name, weekPart, dayPart, hourPart, muscleGroupID1, muscleGroupID2, calPerTime, desc) VALUES (1010, 'Jump Squats', 2, 2, 2, 2, 0, 10, 'Make sure you have space in front of you. Bend into a half-squat with your arms behind you, then jump and swing your arms up as if youre celebrating. ');",
            "INSERT INTO WORKOUT_SCHEDULE (workoutID, name, weekPart, dayPart, hourPart, muscleGroupID1, muscleGroupID2, calPerTime, desc) VALUES (1011, 'Char Dips', 2, 3, 3, 4, 3, 7, 'With your legs out in front of you, grab the edge of a chair (or desk) and lift yourself down and back up. At the end, youll be conveniently back in your seat. ');",
            "INSERT INTO WORKOUT_SCHEDULE (workoutID, name, weekPart, dayPart, hourPart, muscleGroupID1, muscleGroupID2, calPerTime, desc) VALUES (1012, 'Walking', 4, 5, 3, 2, 0, 4, 'Lap your block or a floor of your office. Try for a pace of 100 steps per minute, which is easy if you dont stop to play with tchotchkes on other peoples desks. ');",
            "INSERT INTO WORKOUT_SCHEDULE (workoutID, name, weekPart, dayPart, hourPart, muscleGroupID1, muscleGroupID2, calPerTime, desc) VALUES (1013, 'BaSuCo', 4, 5, 3, 2, 0, 4, 'Nod your head. Like this. Nod your Head. Like This. Lemme see you nod your head.');"
    };
    ...
    private void ProcessBatchOfSqlStatements(String[] sqlStmts, SQLiteDatabase db) {
        for (int iter = 0; iter < sqlStmts.length; iter++){
            android.util.Log.d("Iter","ITEM:"+sqlStmts[iter]);
    ...
    public List<WorkoutSchedule> getAllWorkoutScheduleEntries()
    {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                entry.setDesc(cursor.getString(8));
